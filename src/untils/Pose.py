...
class Pose3D(Pose):
    ...
    def oplus(AxB, BxC):
        ...
        AxC = Pose3D(np.array([ [AxB[0,0] + BxC[0,0]*cos(AxB[2,0]) - BxC[1,0]*sin(AxB[2,0])],
    ...
    def J_2oplus(AxB):
        ...
        """
        # TODO: To be completed by the student
        J2 = np.array([[cos(AxB[2,0]),    -sin(AxB[2,0]),   0.0],
                       [sin(AxB[2,0]),     cos(AxB[2,0]),   0.0],
                       [0.0,               0.0,             1.0]])
        return J2
    ...
    def ominus(AxB):
        ...
        """
        # TODO: To be completed by the student
        AxB = Pose3D(np.array([ [-AxB[0,0]*cos(AxB[2,0]) - AxB[1,0]*sin(AxB[2,0])],
